...
const Navbar = () => {
  ...
  className="flex items-center gap-5 text-2xl font-bold bg-gradient-primary bg-clip-text text-transparent cursor-pointer"
...
>
  ...
  scrollToSection("#showcase");
    ...
    title="Talk with my AI assistant"
  >
    <Bot className="h-6 w-6 text-primary drop-shadow-[0_0_6px_rgba(59,130,246,0.8)]" />
  </motion.div>
