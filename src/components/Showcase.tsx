...
const Showcase = () => {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "bot",
      text: "Hi! I'm Shlok's AI assistant. Ask me anything about his skills, projects, internships, or education.",
    },
  ]);

  const [input, setInput] = useState("");

  // 🔥 Send message to backend RAG AI
  const handleSend = async () => {
    ...
    try {
      ...
      setMessages((prev) => [
        ...
        {
          role: "bot",
          text: "⚠️ AI server not responding. Please make sure the backend is running.",
        },
      ]);
    }
  };
